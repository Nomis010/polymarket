import { adminUsername, createToken, getData, publicUser, readBody, safeUsername, send, suspensionMessage, verifyPassword } from '../_store.js';
...
export default async function handler(req, res) {
  ...
  if (storedUser.suspendedUntil && storedUser.suspendedUntil > Date.now()) {
    return send(res, { error: suspensionMessage(storedUser) }, 403);
  }
